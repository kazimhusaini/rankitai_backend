...
/**
 * Analyze competitor content from the app store.
 */
...
//         // Step 2: Handle Modals (Click "Read More" if present)
//         const readMoreBtnSelector = "button[aria-label='Read more']"; 
//         if (await page.$(readMoreBtnSelector)) {
...
//         // Step 3: Scroll to Load All Content
//         await autoScroll(page);

//         // Step 4: Extract Full Page Content (Text Only)
//         const pageContent = await page.evaluate(() => {
//             return document.body.innerText.trim();
//         });

//         console.log(`✅ Extracted Page Content: ${pageContent.substring(0, 300)}...`); // Preview
...
//         // Step 5: Send Extracted Data to AI for Analysis
//         const response = await axios.post(
//             "https://openrouter.ai/api/v1/chat/completions",
//             {
//                 model: "mistralai/mistral-7b-instruct:free",
...
//                     {
//                         role: "system",
//                         content: "You are an ASO expert. Analyze the given competitor app listing and provide key insights."
//                     },
//                     {
//                         role: "user",
...
//         res.json({ competitorContent: pageContent, analysis });
//     } catch (error) {
